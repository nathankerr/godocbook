...
import (
	"archive/zip"
	"github.com/nathankerr/godocbook/Godeps/_workspace/src/bitbucket.org/kardianos/osext"
	"github.com/nathankerr/godocbook/Godeps/_workspace/src/github.com/daaku/go.zipexe"
	"os"
	"path/filepath"
	"strings"
	"time"
